...
SOURCEFILES := plugin/src/MaxdomPluginObject.cpp plugin/src/PluginMain.cpp plugin/src/PluginNPN.cpp plugin/src/SystemInfoManager.cpp
EXTERNAL_LIBS := 
...
$(BINARYDIR)/MaxdomPluginObject.o : plugin/src/MaxdomPluginObject.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/PluginMain.o : plugin/src/PluginMain.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/PluginNPN.o : plugin/src/PluginNPN.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/SystemInfoManager.o : plugin/src/SystemInfoManager.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)
